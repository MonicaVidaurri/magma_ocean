...
def get_XFeO(temp_kelvin, pressure_pa, mass_magma_ocean, radius_planet, 
             gravity, mole_fractions, mass_O2_total):
    """
    ...
    # --- Constants & Geometry ---
    molar_mass_O2 = 15.9994e-3 * 2.0  # kg/mol
    ...
    def objective_function(guess_XFeO):
        ...
        ln_fO2_kc = (log_ferric_ferrous_ratio + static_kc_sum) / 0.196
    ...
    # We use a tiny epsilon (1e-15) to prevent log(0) at the absolute boundaries.
    lower_bound = 1e-15
    upper_bound = frac_FeOt - 1e-15
