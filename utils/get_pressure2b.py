...
def get_pressure2b(
    ...
    if temp_mantle > temp_solidus_static:
        ...
        # Get melt fraction (passing the master params)
        ...
        # Uses the specific iteration limit for version 'b' from TOML
        for _ in range(num['max_nr_iterations_b']):
