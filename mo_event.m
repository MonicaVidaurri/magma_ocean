function [fun,isterminal,direction] = mo_event(t,Tr);
...
FH2Os = Tr(3)/Mmantle;
[exchangeP,meltfrac] = get_meltfrac(gp,Tr(1),Rp,Rc,Mmantle);
[q_mantle,Db,uc,Ra,nu] = mantleheatflux(Tr(1),Tr(7),Tr(2),Rp,Rc,gp,rho,FH2Os,meltfrac);
